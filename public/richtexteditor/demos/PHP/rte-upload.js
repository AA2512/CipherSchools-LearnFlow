...
//HomeController.cs 
var uploadhandlerpath = "/rte-upload.php";

//set as window.rte_file_upload_handler so RTE will call it 
//https://richtexteditor.com/docs/uploadfiles.aspx
function rte_file_upload_handler(file, callback, optionalIndex, optionalFiles) {
	...
	formdata.append("fileforphp",file);
	xh.send(formdata);
}



console.log(window.rte_file_upload_handler)
